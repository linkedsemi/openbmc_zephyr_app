...
namespace sdbusplus::error::xyz::openbmc_project::software::image
{
struct BusyFailure;
} // namespace sdbusplus::error::xyz::openbmc_project::software::image
namespace sdbusplus::error::xyz::openbmc_project::software::image
...
namespace sdbusplus::error::xyz::openbmc_project::software::update
{
struct Incompatible;
} // namespace sdbusplus::error::xyz::openbmc_project::software::update
namespace sdbusplus::error::xyz::openbmc_project::software::update
...
namespace com::ibm::VPD
{
using UnknownSystemType =
    phosphor::logging::com::ibm::vpd::UnknownSystemType;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::com::ibm::vpd::UnknownSystemType>
{
    using type =
        phosphor::logging::com::ibm::vpd::UnknownSystemType;
};
...
namespace xyz::openbmc_project::software::update
{
...
{
using Incompatible =
    phosphor::logging::xyz::openbmc_project::software::update::Incompatible;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::update::Incompatible>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::update::Incompatible;
};
...
using InvalidSignature =
    phosphor::logging::xyz::openbmc_project::software::update::InvalidSignature;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::update::InvalidSignature>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::update::InvalidSignature;
};
...
{
using InvalidImage =
    phosphor::logging::xyz::openbmc_project::software::update::InvalidImage;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::update::InvalidImage>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::update::InvalidImage;
};
...
namespace xyz::openbmc_project::software::image
{
...
{
using UnTarFailure =
    phosphor::logging::xyz::openbmc_project::software::image::UnTarFailure;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::image::UnTarFailure>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::image::UnTarFailure;
};
...
namespace xyz::openbmc_project::Software::Image
{
using ManifestFileFailure =
    phosphor::logging::xyz::openbmc_project::software::image::ManifestFileFailure;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::image::ManifestFileFailure>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::image::ManifestFileFailure;
};
...
{
using InternalFailure =
    phosphor::logging::xyz::openbmc_project::software::image::InternalFailure;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::image::InternalFailure>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::image::InternalFailure;
};
...
{
using ImageFailure =
    phosphor::logging::xyz::openbmc_project::software::image::ImageFailure;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::image::ImageFailure>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::image::ImageFailure;
};
...
{
using BusyFailure =
    phosphor::logging::xyz::openbmc_project::software::image::BusyFailure;
}
#endif
...
template <>
struct map_exception_type<sdbusplus::error::xyz::openbmc_project::software::image::BusyFailure>
{
    using type =
        phosphor::logging::xyz::openbmc_project::software::image::BusyFailure;
};
